...
parser.add_argument("--output_path", type=str, default="DDI_prediction")
parser.add_argument("--model_path", type=str, default="huggyllama/llama-7b")
parser.add_argument("--token_path", type=str, default=None)
parser.add_argument("--lora_path", type=str, default="qlora-output")
...
# not recommend, may cause performance issue
# use auto_completion instead
